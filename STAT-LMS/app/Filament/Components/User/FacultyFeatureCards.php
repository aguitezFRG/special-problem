                ...
                <a href="/app/catalogs" class="block">
                    <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:bg-gray-50 cursor-pointer transition">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-gray-500">Search and filter research materials by title, author, type, format, date, and SDG tags.</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="/app/requests" class="block">
                    <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:bg-gray-50 cursor-pointer transition">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-gray-500">View all your pending and completed requests with real-time status updates.</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="/app/requests" class="block">
                    <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:bg-gray-50 cursor-pointer transition">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-gray-500">Cancel pending requests before they are approved.</p>
                        </div>
                    </div>
                </a>
