<x-filament::section>
    <h2 class="mb-4 text-base font-semibold text-gray-700 dark:text-gray-200">What you can do</h2>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">

        <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            ...
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Search and filter research materials by title, author, type, format, and SDG tags.</p>
            </div>
        </div>
        ...
        <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            ...
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">View your pending and completed requests with real-time updates.</p>
            </div>
        </div>
        ...
        <div class="flex gap-4 rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            ...
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">Cancel pending requests before approval.</p>
            </div>
        </div>
